...
const ITEM_HEIGHT = 60; // 单个数字的逻辑高度 (px)
    ...
    >
      ...
      >
        {range.map((num, i) => (
          ...
          >
            <span className="text-[52px] tracking-tight transition-colors duration-150" style={{ fontVariantNumeric: 'tabular-nums' }}>
              {num}
            </span>
          </div>
        ))}
