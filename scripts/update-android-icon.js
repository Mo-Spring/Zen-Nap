...
// --- 文件名定义 (v4 强制刷新) ---
const FG_NAME = 'zen_sleep_fore_v4'; 
const BG_NAME = 'zen_sleep_back_v4';
...
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- 纤细 C 型新月 (左侧) -->
    <!-- 外弧半径 9，内弧半径 7.5，形成优雅的新月 -->
    <path
        android:fillColor="${COLOR_MOON}"
        android:pathData="M 10 3 A 9 9 0 1 0 10 21 A 7.5 7.5 0 0 1 10 3 Z" />
    ...
    <path
        ...
        android:pathData="M 14 12 H 18 L 14 17 H 18" />
    ...
    <path
        ...
        android:strokeLineCap="round"
        android:strokeLineJoin="round"
        android:pathData="M 19 6 H 22 L 19 9 H 22" />
</vector>`;
...
function updateIcons() {
    console.log('🌙 Generating "Zen Sleep" Icons v4 (Thinner Moon + Diagonal Zs)...');
    ...
    try {
        console.log('1️⃣  Writing new vector XMLs (v4)...');
        ...
        console.log('✅ Icons Updated to "Zen Sleep v4" style (Refined Moon & Zs)!');
