...
// --- 新设计：禅意睡眠 v5 (Zen Sleep Final Fix) ---
...
// --- 文件名定义 (v5 强制刷新) ---
const FG_NAME = 'zen_sleep_fore_v5'; 
const BG_NAME = 'zen_sleep_back_v5';
...
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- 修正后的 C 型新月 (左侧) -->
    <!-- 使用数学上有效的半径 (R > 半个跨度 7) 确保渲染正确 -->
    <path
        android:fillColor="${COLOR_MOON}"
        android:pathData="M 13 5 A 8 8 0 1 0 13 19 A 7.1 7.1 0 0 1 13 5 Z" />
    ...
    <path
        ...
        android:pathData="M 15 13 H 19 L 15 17 H 19" />
    ...
    <path
        ...
        android:strokeLineCap="round"
        android:strokeLineJoin="round"
        android:pathData="M 20 5 H 23 L 20 8 H 23" />
</vector>`;
...
function updateIcons() {
    console.log('🌙 Generating "Zen Sleep" Icons v5 (Corrected Moon + Zs)...');
    ...
    try {
        console.log('1️⃣  Writing new vector XMLs (v5)...');
        ...
        console.log('✅ Icons Updated to "Zen Sleep v5" style (Fixed Moon Geometry)!');
